...
//
//        static RestApiJsonParser<std::vector<Trade> > getDataListParser() {
//
...
//        }
//
//        static RestApiJsonParser<Trade > getTickParser() {
//            RestApiJsonParser< Trade> res;
//            res.parseJson = [](JsonWrapper json) {
