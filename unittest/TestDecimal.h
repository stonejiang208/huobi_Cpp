...
TEST(TestDecimal, Div) {
    {
        Decimal a("123.456");
        Decimal b("456.123");
        ASSERT_EQ(Decimal("0.27066383409738162732420860162719266513637768759742437895041469077419905879001126"), a / b);
        a /= b;
        printf("!!!!!");
        printf(a.toString().c_str());
        ASSERT_EQ(Decimal("0.27066383409738162732420860162719266513637768759742437895041469077419905879001126"), a);
    }
    {
        Decimal a("0");
        Decimal b("456.123");
