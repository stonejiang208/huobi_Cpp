...
//
//    DepthSize DepthSize::SIZE_5 = DepthSize("5");
//    DepthSize DepthSize::SIZE_10 = DepthSize("10");
//    DepthSize DepthSize::SIZE_20 = DepthSize("20");
//
//}
//
/*
...
template<> std::map<std::string, void *> BaseEnumClass<class_name>::m_lookupMap = {}
    ...
    IMPL_LOOKUP_ENUM_CLASS(StopOrderOperator);
    StopOrderOperator StopOrderOperator::greater_than_and_equal = StopOrderOperator("gte");
    StopOrderOperator StopOrderOperator::less_than_and_equal = StopOrderOperator("lte");

    IMPL_LOOKUP_ENUM_CLASS(DealRole);
    DealRole DealRole::taker = DealRole("taker");
    DealRole DealRole::maker = DealRole("maker");

    IMPL_LOOKUP_ENUM_CLASS(SymbolState);
    SymbolState SymbolState::online = SymbolState("online");
    SymbolState SymbolState::offline = SymbolState("offline");
    SymbolState SymbolState::suspend = SymbolState("suspend");

    IMPL_LOOKUP_ENUM_CLASS(TransferFuturesType);
    TransferFuturesType TransferFuturesType::futures_to_pro = TransferFuturesType("futures-to-pro");
    TransferFuturesType TransferFuturesType::pro_to_futures = TransferFuturesType("pro-to-futures");

    IMPL_LOOKUP_ENUM_CLASS(DepthStep);
    DepthStep DepthStep::step0 = DepthStep("step0");
    DepthStep DepthStep::step1 = DepthStep("step1");
    DepthStep DepthStep::step2 = DepthStep("step2");
    DepthStep DepthStep::step3 = DepthStep("step3");
    ...
    IMPL_LOOKUP_ENUM_CLASS(ExchangeEnum);
    ExchangeEnum ExchangeEnum::huobi = ExchangeEnum("huobi");

    IMPL_LOOKUP_ENUM_CLASS(ConnectionStateEnum);
    ConnectionStateEnum ConnectionStateEnum::IDLE = ConnectionStateEnum("IDLE");
    ConnectionStateEnum ConnectionStateEnum::DELAY_CONNECT = ConnectionStateEnum("DELAY_CONNECT");
    ConnectionStateEnum ConnectionStateEnum::CONNECTED = ConnectionStateEnum("CONNECTED");
    ConnectionStateEnum ConnectionStateEnum::CLOSED_ON_ERROR = ConnectionStateEnum("CLOSED_ON_ERROR");

    IMPL_LOOKUP_ENUM_CLASS(DepthSize);
    DepthSize DepthSize::SIZE_5 = DepthSize("5");
    DepthSize DepthSize::SIZE_10 = DepthSize("10");
    DepthSize DepthSize::SIZE_20 = DepthSize("20");
